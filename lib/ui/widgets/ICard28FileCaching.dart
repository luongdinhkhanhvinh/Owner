...
class ICard28FileCaching extends StatelessWidget {
  ...
  ICard28FileCaching({this.id, this.color = Colors.grey, this.text = "", this.textStyle, this.title = "", this.titleStyle,  this.colorProgressBar = Colors.black,
    this.userAvatar, this.balloonColor = Colors.black, this.balloonText = "", this.balloonStyle, this.enable = true,
    this.callback
  });
