...
//            Text(widget.text2, style: _text2Style, overflow: TextOverflow.ellipsis,),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10,),
                  Text("${item.currency}${item.price.toStringAsFixed(2)} х ${item.count} = ${item.currency}${item.price*item.count}", style: _text2Style,),
                ],)),
            )
    ...
    list.add(Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            Text("${widget.text3}: $currency$_total", style: _text3Style,),
            SizedBox(height: 10,),
